...
@JCStressTest
@Outcome(
    id = "java.lang.Exception,\\s*java.lang.Exception,\\s*java.lang.Exception,\\s*0",
...
@Outcome(
    ...
    desc = "atomic")
@Outcome(
    id = "java.lang.Exception,\\s*0,\\s*java.lang.Exception,\\s*java.lang.Exception",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "java.lang.Exception,\\s*0,\\s*java.lang.Exception,\\s*1",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
