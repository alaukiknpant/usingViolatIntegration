...
@JCStressTest
@Outcome(
    id = "0,\\s*java.lang.Exception,\\s*java.lang.Exception,\\s*0",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "0,\\s*0,\\s*java.lang.Exception,\\s*java.lang.Exception",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@Outcome(
    id = "0,\\s*java.lang.Exception,\\s*0,\\s*java.lang.Exception",
    expect = Expect.ACCEPTABLE,
    desc = "atomic")
@State
public class QueueWrongTest12 {
