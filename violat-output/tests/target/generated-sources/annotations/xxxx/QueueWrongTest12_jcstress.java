...
import xxxx.QueueWrongTest12;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest12_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest12_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest12");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest12 t = new QueueWrongTest12();
        final QueueWrongTest12 s = new QueueWrongTest12();
