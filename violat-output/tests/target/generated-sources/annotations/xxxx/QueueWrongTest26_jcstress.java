...
import xxxx.QueueWrongTest26;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest26_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest26_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest26");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest26 t = new QueueWrongTest26();
        final QueueWrongTest26 s = new QueueWrongTest26();
