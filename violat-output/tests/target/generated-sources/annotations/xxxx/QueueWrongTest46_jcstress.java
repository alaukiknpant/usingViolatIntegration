...
import xxxx.QueueWrongTest46;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest46_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest46_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest46");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest46 t = new QueueWrongTest46();
        final QueueWrongTest46 s = new QueueWrongTest46();
