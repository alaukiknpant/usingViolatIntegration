...
import xxxx.QueueWrongTest29;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest29_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest29_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest29");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest29 t = new QueueWrongTest29();
        final QueueWrongTest29 s = new QueueWrongTest29();
