...
import xxxx.QueueWrongTest99;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest99_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest99_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest99");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest99 t = new QueueWrongTest99();
        final QueueWrongTest99 s = new QueueWrongTest99();
