...
import xxxx.QueueWrongTest59;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest59_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest59_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest59");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest59 t = new QueueWrongTest59();
        final QueueWrongTest59 s = new QueueWrongTest59();
