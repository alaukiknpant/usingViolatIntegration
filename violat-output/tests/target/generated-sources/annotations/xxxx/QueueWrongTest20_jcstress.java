...
import xxxx.QueueWrongTest20;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest20_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest20_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest20");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest20 t = new QueueWrongTest20();
        final QueueWrongTest20 s = new QueueWrongTest20();
