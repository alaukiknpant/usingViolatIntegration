...
import xxxx.QueueWrongTest86;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest86_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest86_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest86");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest86 t = new QueueWrongTest86();
        final QueueWrongTest86 s = new QueueWrongTest86();
