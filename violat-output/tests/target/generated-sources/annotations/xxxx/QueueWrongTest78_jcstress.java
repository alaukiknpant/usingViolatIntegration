...
import xxxx.QueueWrongTest78;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class QueueWrongTest78_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public QueueWrongTest78_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest78");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest78 t = new QueueWrongTest78();
        final QueueWrongTest78 s = new QueueWrongTest78();
