...
import xxxx.QueueWrongTest53;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest53_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest53_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest53");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest53 t = new QueueWrongTest53();
        final QueueWrongTest53 s = new QueueWrongTest53();
