...
import xxxx.QueueWrongTest85;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest85_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest85_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest85");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest85 t = new QueueWrongTest85();
        final QueueWrongTest85 s = new QueueWrongTest85();
