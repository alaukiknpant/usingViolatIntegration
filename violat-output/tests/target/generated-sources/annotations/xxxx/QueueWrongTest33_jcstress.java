...
import xxxx.QueueWrongTest33;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest33_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest33_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest33");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest33 t = new QueueWrongTest33();
        final QueueWrongTest33 s = new QueueWrongTest33();
