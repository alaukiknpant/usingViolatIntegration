...
import xxxx.QueueWrongTest1;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest1_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest1_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest1");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest1 t = new QueueWrongTest1();
        final QueueWrongTest1 s = new QueueWrongTest1();
