...
import xxxx.QueueWrongTest43;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest43_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest43_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest43");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest43 t = new QueueWrongTest43();
        final QueueWrongTest43 s = new QueueWrongTest43();
