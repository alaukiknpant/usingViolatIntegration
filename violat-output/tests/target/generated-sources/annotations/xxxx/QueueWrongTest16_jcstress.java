...
import xxxx.QueueWrongTest16;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest16_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest16_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest16");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest16 t = new QueueWrongTest16();
        final QueueWrongTest16 s = new QueueWrongTest16();
