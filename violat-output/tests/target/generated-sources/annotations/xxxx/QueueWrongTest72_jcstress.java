...
import xxxx.QueueWrongTest72;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest72_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest72_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest72");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest72 t = new QueueWrongTest72();
        final QueueWrongTest72 s = new QueueWrongTest72();
