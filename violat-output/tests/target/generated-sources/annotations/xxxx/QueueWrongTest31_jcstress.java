...
import xxxx.QueueWrongTest31;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest31_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest31_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest31");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest31 t = new QueueWrongTest31();
        final QueueWrongTest31 s = new QueueWrongTest31();
