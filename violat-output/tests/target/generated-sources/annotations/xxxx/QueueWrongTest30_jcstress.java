...
import xxxx.QueueWrongTest30;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest30_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest30_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest30");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest30 t = new QueueWrongTest30();
        final QueueWrongTest30 s = new QueueWrongTest30();
