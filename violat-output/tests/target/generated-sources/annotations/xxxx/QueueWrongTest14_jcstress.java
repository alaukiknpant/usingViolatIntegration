...
import xxxx.QueueWrongTest14;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest14_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest14_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest14");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest14 t = new QueueWrongTest14();
        final QueueWrongTest14 s = new QueueWrongTest14();
