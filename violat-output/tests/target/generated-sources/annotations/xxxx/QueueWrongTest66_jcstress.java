...
import xxxx.QueueWrongTest66;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class QueueWrongTest66_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public QueueWrongTest66_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest66");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest66 t = new QueueWrongTest66();
        final QueueWrongTest66 s = new QueueWrongTest66();
