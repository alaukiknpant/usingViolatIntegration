...
import xxxx.QueueWrongTest39;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest39_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest39_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest39");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest39 t = new QueueWrongTest39();
        final QueueWrongTest39 s = new QueueWrongTest39();
