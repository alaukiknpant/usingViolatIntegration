...
import xxxx.QueueWrongTest87;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest87_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest87_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest87");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest87 t = new QueueWrongTest87();
        final QueueWrongTest87 s = new QueueWrongTest87();
