...
import xxxx.QueueWrongTest42;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest42_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest42_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest42");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest42 t = new QueueWrongTest42();
        final QueueWrongTest42 s = new QueueWrongTest42();
