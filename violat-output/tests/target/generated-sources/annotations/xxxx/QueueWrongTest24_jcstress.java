...
import xxxx.QueueWrongTest24;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest24_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest24_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest24");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest24 t = new QueueWrongTest24();
        final QueueWrongTest24 s = new QueueWrongTest24();
