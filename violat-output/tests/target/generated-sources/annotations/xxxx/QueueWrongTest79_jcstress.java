...
import xxxx.QueueWrongTest79;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest79_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest79_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest79");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest79 t = new QueueWrongTest79();
        final QueueWrongTest79 s = new QueueWrongTest79();
