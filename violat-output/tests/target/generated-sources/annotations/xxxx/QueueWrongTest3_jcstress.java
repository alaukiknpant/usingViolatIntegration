...
import xxxx.QueueWrongTest3;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest3_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest3_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest3");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest3 t = new QueueWrongTest3();
        final QueueWrongTest3 s = new QueueWrongTest3();
