...
import xxxx.QueueWrongTest41;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest41_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest41_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest41");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest41 t = new QueueWrongTest41();
        final QueueWrongTest41 s = new QueueWrongTest41();
