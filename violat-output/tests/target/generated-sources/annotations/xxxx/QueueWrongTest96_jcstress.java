...
import xxxx.QueueWrongTest96;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest96_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest96_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest96");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest96 t = new QueueWrongTest96();
        final QueueWrongTest96 s = new QueueWrongTest96();
