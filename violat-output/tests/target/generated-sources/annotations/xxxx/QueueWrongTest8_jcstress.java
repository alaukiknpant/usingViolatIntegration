...
import xxxx.QueueWrongTest8;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueWrongTest8_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueWrongTest8_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest8");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest8 t = new QueueWrongTest8();
        final QueueWrongTest8 s = new QueueWrongTest8();
