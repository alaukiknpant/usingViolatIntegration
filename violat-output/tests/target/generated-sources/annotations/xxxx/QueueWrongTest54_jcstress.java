...
import xxxx.QueueWrongTest54;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest54_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest54_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest54");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest54 t = new QueueWrongTest54();
        final QueueWrongTest54 s = new QueueWrongTest54();
