...
import xxxx.QueueWrongTest7;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest7_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest7_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest7");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest7 t = new QueueWrongTest7();
        final QueueWrongTest7 s = new QueueWrongTest7();
