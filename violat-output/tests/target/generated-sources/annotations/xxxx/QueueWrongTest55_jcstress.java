...
import xxxx.QueueWrongTest55;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest55_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest55_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest55");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest55 t = new QueueWrongTest55();
        final QueueWrongTest55 s = new QueueWrongTest55();
