...
import xxxx.QueueWrongTest58;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest58_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest58_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest58");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest58 t = new QueueWrongTest58();
        final QueueWrongTest58 s = new QueueWrongTest58();
