...
import xxxx.QueueWrongTest65;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest65_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest65_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest65");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest65 t = new QueueWrongTest65();
        final QueueWrongTest65 s = new QueueWrongTest65();
