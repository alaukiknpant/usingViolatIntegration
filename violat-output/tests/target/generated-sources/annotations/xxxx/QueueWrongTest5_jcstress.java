...
import xxxx.QueueWrongTest5;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest5_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest5_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest5");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest5 t = new QueueWrongTest5();
        final QueueWrongTest5 s = new QueueWrongTest5();
