...
import xxxx.QueueWrongTest51;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest51_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest51_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest51");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest51 t = new QueueWrongTest51();
        final QueueWrongTest51 s = new QueueWrongTest51();
