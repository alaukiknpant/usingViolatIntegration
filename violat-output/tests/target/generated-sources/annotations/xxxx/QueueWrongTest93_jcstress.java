...
import xxxx.QueueWrongTest93;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest93_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest93_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest93");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest93 t = new QueueWrongTest93();
        final QueueWrongTest93 s = new QueueWrongTest93();
