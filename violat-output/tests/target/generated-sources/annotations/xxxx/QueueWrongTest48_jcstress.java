...
import xxxx.QueueWrongTest48;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest48_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest48_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest48");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest48 t = new QueueWrongTest48();
        final QueueWrongTest48 s = new QueueWrongTest48();
