...
import xxxx.QueueWrongTest27;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest27_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest27_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest27");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest27 t = new QueueWrongTest27();
        final QueueWrongTest27 s = new QueueWrongTest27();
