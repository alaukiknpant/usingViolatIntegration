...
import xxxx.QueueWrongTest57;
import org.openjdk.jcstress.infra.results.StringResult0_jcstress;

public class QueueWrongTest57_jcstress extends Runner<StringResult0_jcstress> {
    ...
    public QueueWrongTest57_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest57");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest57 t = new QueueWrongTest57();
        final QueueWrongTest57 s = new QueueWrongTest57();
