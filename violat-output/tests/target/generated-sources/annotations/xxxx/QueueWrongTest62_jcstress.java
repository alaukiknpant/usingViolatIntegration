...
import xxxx.QueueWrongTest62;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest62_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest62_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest62");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest62 t = new QueueWrongTest62();
        final QueueWrongTest62 s = new QueueWrongTest62();
