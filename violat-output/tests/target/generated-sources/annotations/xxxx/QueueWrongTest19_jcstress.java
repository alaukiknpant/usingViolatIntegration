...
import xxxx.QueueWrongTest19;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest19_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest19_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest19");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest19 t = new QueueWrongTest19();
        final QueueWrongTest19 s = new QueueWrongTest19();
