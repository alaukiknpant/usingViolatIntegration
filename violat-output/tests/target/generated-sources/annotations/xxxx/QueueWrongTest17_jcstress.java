...
import xxxx.QueueWrongTest17;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest17_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest17_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest17");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest17 t = new QueueWrongTest17();
        final QueueWrongTest17 s = new QueueWrongTest17();
