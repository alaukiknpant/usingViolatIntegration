...
import xxxx.QueueWrongTest23;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest23_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest23_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest23");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest23 t = new QueueWrongTest23();
        final QueueWrongTest23 s = new QueueWrongTest23();
