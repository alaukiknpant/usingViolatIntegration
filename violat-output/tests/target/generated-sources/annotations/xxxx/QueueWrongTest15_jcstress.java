...
import xxxx.QueueWrongTest15;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest15_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest15_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest15");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest15 t = new QueueWrongTest15();
        final QueueWrongTest15 s = new QueueWrongTest15();
