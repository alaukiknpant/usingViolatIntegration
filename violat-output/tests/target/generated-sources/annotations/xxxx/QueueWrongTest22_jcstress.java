...
import xxxx.QueueWrongTest22;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest22_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest22_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest22");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest22 t = new QueueWrongTest22();
        final QueueWrongTest22 s = new QueueWrongTest22();
