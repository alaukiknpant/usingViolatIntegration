...
import xxxx.QueueWrongTest40;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest40_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest40_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest40");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest40 t = new QueueWrongTest40();
        final QueueWrongTest40 s = new QueueWrongTest40();
