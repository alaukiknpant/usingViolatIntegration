...
import xxxx.QueueWrongTest34;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest34_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest34_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest34");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest34 t = new QueueWrongTest34();
        final QueueWrongTest34 s = new QueueWrongTest34();
