...
import xxxx.QueueWrongTest35;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest35_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest35_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest35");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest35 t = new QueueWrongTest35();
        final QueueWrongTest35 s = new QueueWrongTest35();
