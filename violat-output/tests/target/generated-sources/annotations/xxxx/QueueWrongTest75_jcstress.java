...
import xxxx.QueueWrongTest75;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest75_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest75_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest75");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest75 t = new QueueWrongTest75();
        final QueueWrongTest75 s = new QueueWrongTest75();
