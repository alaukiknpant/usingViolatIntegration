...
import xxxx.QueueWrongTest77;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest77_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest77_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest77");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest77 t = new QueueWrongTest77();
        final QueueWrongTest77 s = new QueueWrongTest77();
