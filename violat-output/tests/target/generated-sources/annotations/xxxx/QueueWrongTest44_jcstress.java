...
import xxxx.QueueWrongTest44;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest44_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest44_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest44");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest44 t = new QueueWrongTest44();
        final QueueWrongTest44 s = new QueueWrongTest44();
