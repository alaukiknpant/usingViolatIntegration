...
import xxxx.QueueWrongTest45;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest45_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest45_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest45");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest45 t = new QueueWrongTest45();
        final QueueWrongTest45 s = new QueueWrongTest45();
