...
import xxxx.QueueWrongTest9;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest9_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest9_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest9");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest9 t = new QueueWrongTest9();
        final QueueWrongTest9 s = new QueueWrongTest9();
