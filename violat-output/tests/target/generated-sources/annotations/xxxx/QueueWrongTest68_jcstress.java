...
import xxxx.QueueWrongTest68;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest68_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest68_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest68");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest68 t = new QueueWrongTest68();
        final QueueWrongTest68 s = new QueueWrongTest68();
