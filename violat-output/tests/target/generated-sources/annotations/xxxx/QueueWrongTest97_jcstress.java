...
import xxxx.QueueWrongTest97;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest97_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest97_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest97");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest97 t = new QueueWrongTest97();
        final QueueWrongTest97 s = new QueueWrongTest97();
