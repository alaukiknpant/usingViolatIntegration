...
import xxxx.QueueWrongTest47;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class QueueWrongTest47_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public QueueWrongTest47_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest47");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest47 t = new QueueWrongTest47();
        final QueueWrongTest47 s = new QueueWrongTest47();
