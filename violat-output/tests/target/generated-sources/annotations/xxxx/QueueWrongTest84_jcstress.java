...
import xxxx.QueueWrongTest84;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest84_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest84_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest84");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest84 t = new QueueWrongTest84();
        final QueueWrongTest84 s = new QueueWrongTest84();
