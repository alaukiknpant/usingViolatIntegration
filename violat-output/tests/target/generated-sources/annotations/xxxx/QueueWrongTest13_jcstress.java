...
import xxxx.QueueWrongTest13;
import org.openjdk.jcstress.infra.results.StringResult5_jcstress;

public class QueueWrongTest13_jcstress extends Runner<StringResult5_jcstress> {
    ...
    public QueueWrongTest13_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest13");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest13 t = new QueueWrongTest13();
        final QueueWrongTest13 s = new QueueWrongTest13();
