...
import xxxx.QueueWrongTest63;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest63_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest63_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest63");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest63 t = new QueueWrongTest63();
        final QueueWrongTest63 s = new QueueWrongTest63();
