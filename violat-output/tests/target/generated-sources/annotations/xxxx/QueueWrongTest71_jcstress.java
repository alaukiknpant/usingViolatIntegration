...
import xxxx.QueueWrongTest71;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest71_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest71_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest71");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest71 t = new QueueWrongTest71();
        final QueueWrongTest71 s = new QueueWrongTest71();
