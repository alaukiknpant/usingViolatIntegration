...
import xxxx.QueueWrongTest56;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest56_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest56_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest56");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest56 t = new QueueWrongTest56();
        final QueueWrongTest56 s = new QueueWrongTest56();
