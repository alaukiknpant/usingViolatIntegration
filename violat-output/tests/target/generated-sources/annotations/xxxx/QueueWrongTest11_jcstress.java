...
import xxxx.QueueWrongTest11;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest11_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest11_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest11");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest11 t = new QueueWrongTest11();
        final QueueWrongTest11 s = new QueueWrongTest11();
