...
import xxxx.QueueWrongTest92;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest92_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest92_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest92");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest92 t = new QueueWrongTest92();
        final QueueWrongTest92 s = new QueueWrongTest92();
