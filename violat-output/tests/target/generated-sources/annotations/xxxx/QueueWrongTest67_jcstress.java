...
import xxxx.QueueWrongTest67;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest67_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest67_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest67");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest67 t = new QueueWrongTest67();
        final QueueWrongTest67 s = new QueueWrongTest67();
