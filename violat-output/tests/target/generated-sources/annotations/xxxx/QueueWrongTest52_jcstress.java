...
import xxxx.QueueWrongTest52;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest52_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest52_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest52");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest52 t = new QueueWrongTest52();
        final QueueWrongTest52 s = new QueueWrongTest52();
