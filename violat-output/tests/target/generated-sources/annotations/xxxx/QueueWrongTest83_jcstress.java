...
import xxxx.QueueWrongTest83;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest83_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest83_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest83");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest83 t = new QueueWrongTest83();
        final QueueWrongTest83 s = new QueueWrongTest83();
