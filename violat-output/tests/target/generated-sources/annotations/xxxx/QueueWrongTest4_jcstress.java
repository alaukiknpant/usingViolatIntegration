...
import xxxx.QueueWrongTest4;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest4_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest4_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest4");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest4 t = new QueueWrongTest4();
        final QueueWrongTest4 s = new QueueWrongTest4();
