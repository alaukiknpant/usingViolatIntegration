...
import xxxx.QueueWrongTest28;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest28_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest28_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest28");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest28 t = new QueueWrongTest28();
        final QueueWrongTest28 s = new QueueWrongTest28();
