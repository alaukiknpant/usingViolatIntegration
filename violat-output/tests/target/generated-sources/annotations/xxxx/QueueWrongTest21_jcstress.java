...
import xxxx.QueueWrongTest21;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest21_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest21_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest21");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest21 t = new QueueWrongTest21();
        final QueueWrongTest21 s = new QueueWrongTest21();
