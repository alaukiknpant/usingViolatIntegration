...
import xxxx.QueueWrongTest89;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest89_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest89_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest89");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest89 t = new QueueWrongTest89();
        final QueueWrongTest89 s = new QueueWrongTest89();
