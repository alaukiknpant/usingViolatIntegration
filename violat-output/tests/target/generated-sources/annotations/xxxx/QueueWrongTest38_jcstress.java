...
import xxxx.QueueWrongTest38;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest38_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest38_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest38");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest38 t = new QueueWrongTest38();
        final QueueWrongTest38 s = new QueueWrongTest38();
