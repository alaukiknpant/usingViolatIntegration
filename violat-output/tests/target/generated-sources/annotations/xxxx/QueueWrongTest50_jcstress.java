...
import xxxx.QueueWrongTest50;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest50_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest50_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest50");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest50 t = new QueueWrongTest50();
        final QueueWrongTest50 s = new QueueWrongTest50();
