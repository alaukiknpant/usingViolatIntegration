...
import xxxx.QueueWrongTest88;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest88_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest88_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest88");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest88 t = new QueueWrongTest88();
        final QueueWrongTest88 s = new QueueWrongTest88();
