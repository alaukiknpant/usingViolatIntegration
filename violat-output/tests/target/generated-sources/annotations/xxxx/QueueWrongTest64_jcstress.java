...
import xxxx.QueueWrongTest64;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest64_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest64_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest64");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest64 t = new QueueWrongTest64();
        final QueueWrongTest64 s = new QueueWrongTest64();
