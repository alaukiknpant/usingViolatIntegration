...
import xxxx.QueueWrongTest32;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest32_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest32_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest32");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest32 t = new QueueWrongTest32();
        final QueueWrongTest32 s = new QueueWrongTest32();
