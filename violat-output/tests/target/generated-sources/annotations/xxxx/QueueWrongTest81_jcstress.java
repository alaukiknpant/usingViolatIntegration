...
import xxxx.QueueWrongTest81;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest81_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest81_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest81");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest81 t = new QueueWrongTest81();
        final QueueWrongTest81 s = new QueueWrongTest81();
