...
import xxxx.QueueWrongTest76;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest76_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest76_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest76");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest76 t = new QueueWrongTest76();
        final QueueWrongTest76 s = new QueueWrongTest76();
