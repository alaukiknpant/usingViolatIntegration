...
import xxxx.QueueWrongTest60;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest60_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest60_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest60");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest60 t = new QueueWrongTest60();
        final QueueWrongTest60 s = new QueueWrongTest60();
