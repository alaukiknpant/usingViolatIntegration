...
import xxxx.QueueWrongTest74;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest74_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest74_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest74");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest74 t = new QueueWrongTest74();
        final QueueWrongTest74 s = new QueueWrongTest74();
