...
import xxxx.QueueWrongTest2;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest2_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest2_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest2");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest2 t = new QueueWrongTest2();
        final QueueWrongTest2 s = new QueueWrongTest2();
