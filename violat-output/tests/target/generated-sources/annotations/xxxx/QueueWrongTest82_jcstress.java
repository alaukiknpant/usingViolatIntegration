...
import xxxx.QueueWrongTest82;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest82_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest82_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest82");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest82 t = new QueueWrongTest82();
        final QueueWrongTest82 s = new QueueWrongTest82();
