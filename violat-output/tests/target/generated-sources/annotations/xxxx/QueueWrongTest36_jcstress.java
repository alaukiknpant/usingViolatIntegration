...
import xxxx.QueueWrongTest36;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest36_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest36_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest36");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest36 t = new QueueWrongTest36();
        final QueueWrongTest36 s = new QueueWrongTest36();
