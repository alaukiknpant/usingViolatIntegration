...
import xxxx.QueueWrongTest73;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest73_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest73_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest73");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest73 t = new QueueWrongTest73();
        final QueueWrongTest73 s = new QueueWrongTest73();
