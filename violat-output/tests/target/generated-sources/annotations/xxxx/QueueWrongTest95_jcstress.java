...
import xxxx.QueueWrongTest95;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest95_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest95_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest95");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest95 t = new QueueWrongTest95();
        final QueueWrongTest95 s = new QueueWrongTest95();
