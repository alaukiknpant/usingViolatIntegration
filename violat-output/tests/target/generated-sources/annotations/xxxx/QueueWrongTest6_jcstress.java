...
import xxxx.QueueWrongTest6;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest6_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest6_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest6");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest6 t = new QueueWrongTest6();
        final QueueWrongTest6 s = new QueueWrongTest6();
