...
import xxxx.QueueWrongTest61;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest61_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest61_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest61");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest61 t = new QueueWrongTest61();
        final QueueWrongTest61 s = new QueueWrongTest61();
