...
import xxxx.QueueWrongTest70;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest70_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest70_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest70");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest70 t = new QueueWrongTest70();
        final QueueWrongTest70 s = new QueueWrongTest70();
