...
import xxxx.QueueWrongTest91;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest91_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest91_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest91");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest91 t = new QueueWrongTest91();
        final QueueWrongTest91 s = new QueueWrongTest91();
