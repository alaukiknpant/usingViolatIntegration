...
import xxxx.QueueWrongTest69;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest69_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest69_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest69");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest69 t = new QueueWrongTest69();
        final QueueWrongTest69 s = new QueueWrongTest69();
