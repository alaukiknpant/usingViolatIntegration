...
import xxxx.QueueWrongTest37;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest37_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest37_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest37");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest37 t = new QueueWrongTest37();
        final QueueWrongTest37 s = new QueueWrongTest37();
