...
import xxxx.QueueWrongTest49;
import org.openjdk.jcstress.infra.results.StringResult4_jcstress;

public class QueueWrongTest49_jcstress extends Runner<StringResult4_jcstress> {
    ...
    public QueueWrongTest49_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest49");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest49 t = new QueueWrongTest49();
        final QueueWrongTest49 s = new QueueWrongTest49();
