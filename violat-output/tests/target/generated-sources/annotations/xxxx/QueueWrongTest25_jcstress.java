...
import xxxx.QueueWrongTest25;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest25_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest25_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest25");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest25 t = new QueueWrongTest25();
        final QueueWrongTest25 s = new QueueWrongTest25();
