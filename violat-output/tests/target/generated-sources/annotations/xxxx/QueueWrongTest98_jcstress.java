...
import xxxx.QueueWrongTest98;
import org.openjdk.jcstress.infra.results.StringResult2_jcstress;

public class QueueWrongTest98_jcstress extends Runner<StringResult2_jcstress> {
    ...
    public QueueWrongTest98_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest98");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest98 t = new QueueWrongTest98();
        final QueueWrongTest98 s = new QueueWrongTest98();
