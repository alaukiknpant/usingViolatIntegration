...
import xxxx.QueueWrongTest90;
import org.openjdk.jcstress.infra.results.StringResult3_jcstress;

public class QueueWrongTest90_jcstress extends Runner<StringResult3_jcstress> {
    ...
    public QueueWrongTest90_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest90");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest90 t = new QueueWrongTest90();
        final QueueWrongTest90 s = new QueueWrongTest90();
