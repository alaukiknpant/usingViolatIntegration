...
import xxxx.QueueWrongTest0;
import org.openjdk.jcstress.infra.results.StringResult1_jcstress;

public class QueueWrongTest0_jcstress extends Runner<StringResult1_jcstress> {
    ...
    public QueueWrongTest0_jcstress(TestConfig config, TestResultCollector collector, ExecutorService pool) {
        super(config, collector, pool, "xxxx.QueueWrongTest0");
    }
    ...
    private void sanityCheck_API() throws Throwable {
        final QueueWrongTest0 t = new QueueWrongTest0();
        final QueueWrongTest0 s = new QueueWrongTest0();
